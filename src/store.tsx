...
const initialState: AppState = {
  services: [
    ...
    { id: 's4', name: 'Lulur & Scrub Badan', durationMinutes: 60, price: 200000, description: 'Eksfoliasi kulit mati dan pencerahan kulit seluruh tubuh.' },
    { id: 's5', name: 'Pijat Batu Panas (Hot Stone)', durationMinutes: 120, price: 350000, description: 'Terapi pijat menggunakan batu vulkanik panas untuk relaksasi otot mendalam.' },
    { id: 's6', name: 'Bekam Kering / Basah', durationMinutes: 45, price: 150000, description: 'Terapi bekam untuk melancarkan peredaran darah dan membuang toksin.' },
    { id: 's7', name: 'Ear Candle Therapy', durationMinutes: 30, price: 80000, description: 'Terapi lilin telinga untuk membersihkan kotoran dan meredakan vertigo.' },
    { id: 's8', name: 'Pijat Aromaterapi', durationMinutes: 60, price: 200000, description: 'Pijat relaksasi menggunakan minyak esensial pilihan.' },
    { id: 's9', name: 'Pijat Olahraga (Sports Massage)', durationMinutes: 90, price: 300000, description: 'Pijat khusus untuk atlet atau yang sering berolahraga, fokus pada pemulihan otot.' },
    { id: 's10', name: 'Pijat Ibu Hamil (Prenatal Massage)', durationMinutes: 60, price: 250000, description: 'Pijat aman dan nyaman khusus untuk ibu hamil.' },
  ],
  therapists: [
    { id: 't1', name: 'Ayu Lestari', status: 'available', specialties: ['Refleksi', 'Tradisional', 'Bekam'], rating: 4.8 },
    { id: 't2', name: 'Siti Aminah', status: 'busy', specialties: ['Tradisional', 'Totok Wajah', 'Lulur'], rating: 4.9 },
    { id: 't3', name: 'Dian Maharani', status: 'off', specialties: ['Refleksi', 'Hot Stone'], rating: 4.7 },
    { id: 't4', name: 'Rina Melati', status: 'available', specialties: ['Totok Wajah', 'Refleksi', 'Ear Candle'], rating: 4.6 },
  ],
  customers: [
    { id: 'c1', name: 'Nisa Sabyan', phone: '081234567890', totalVisits: 5, lastVisit: new Date(Date.now() - 86400000 * 5).toISOString() },
    ...
    { id: 'c3', name: 'Rini Yulianti', phone: '085612349876', totalVisits: 0 },
  ],
  queue: [
    {
      id: 'q1',
